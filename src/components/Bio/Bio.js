    ...
    return (
        <main id='bio-container'>
            <section className='bio'>
                ...
                <motion.a transition={{delay: 0.75}} initial={{scale: 0}} animate={{scale:1}} target="_blank" href='https://docs.google.com/document/d/1ObhAmSSIMxJcBMwDzsPG6LYI_XB0d7rL9OBp2dvxT3Y/edit?usp=sharing' ><img className='linkedin' src={CV} /></motion.a>
            </div>
                <div className='style'>
